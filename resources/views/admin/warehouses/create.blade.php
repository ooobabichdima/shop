...
<div style="padding:20px 0;">
    ...
    <form method="POST" action="{{ route('admin.warehouses.store') }}">
            ...
            <div style="display:grid;gap:16px;">
                ...
                <div>
                    ...
                    <textarea name="address" rows="2"
                        style="width:100%;padding:12px;border-radius:14px;border:1px solid rgba(255,255,255,.14);background:rgba(0,0,0,.18);color:var(--text);"
                        placeholder="вул. Хрещатик, 1">{{ old('address') }}</textarea>
                </div>
        ...
        <div style="display:flex;gap:10px;">
            <button type="submit" class="btn btn-primary">Створити склад</button>
