...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} html,body{height:100%}
    ...
    summary{cursor:pointer; list-style:none; display:flex; justify-content:space-between; gap:12px; font-weight:950}
    ...
    /* --- Tuning kits + bundle add-ons --- */
    .kits{display:grid; grid-template-columns: 1fr; gap:12px}
    .kit{
      padding:14px;
      border-radius:18px;
      border:1px solid rgba(255,255,255,.12);
    ...
    .addon-check{display:flex; align-items:center; gap:10px; align-self:flex-start}
    .addon-check input[type="checkbox"]{width:16px; height:16px; accent-color: var(--accent)}
    .addon-price{font-weight:950}

    /* NEW: qty inside addon */
...
<body>
  ...
  <main class="container">
    ...
    <section class="product-wrap">
      ...
      <div class="card gallery" aria-label="Галерея товара">
        ...
        <ul class="bullets" style="margin-top:12px;">
          ...
          <li><b>Совместимость</b> <small>LiPo 7.4V — безопасный старт; 11.1V — если электроника/проводка позволяет.</small></li>
      ...
      <div class="card info" aria-label="Информация о товаре">
        ...
        <div class="pricebox">
          <div>
            <div class="price" id="basePrice" data-base-price="9990">9 990 грн <span class="strike">10 990</span></div>
          ...
          <div class="row" style="flex-wrap:wrap; justify-content:flex-end;">
            ...
            <button class="btn primary" type="button" id="addMainToCart">В корзину</button>
        ...
        <div class="tabs" id="tabs">
          ...
          <div class="tabpanel" data-panel="desc">
            <p style="margin:0 0 10px; color:rgba(255,255,255,.84);">
              ...
              Если хочешь “тише/быстрее/дальше” — ниже есть готовые пакеты тюнинга и рекомендованный комплект.
            </p>
          ...
          <div class="tabpanel" data-panel="faq" hidden>
            <div class="qa">
              <details>
                ...
                <p>Для CQB обычно 0.25–0.28г — стабильнее траектория. В лесу часто берут 0.28–0.32г (если площадка/лимиты позволяют).</p>
              </details>
              <details>
                <summary>Можно ли LiPo 11.1V? <span class="chev" aria-hidden="true">
                  <svg class="ico18" viewBox="0 0 24 24" fill="none"><path d="M6 9l6 6 6-6" stroke="rgba(255,255,255,.85)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </span></summary>
                <p>Если модель с корректной электроникой/проводкой — да. Иначе лучше 7.4V для ресурса и стабильности.</p>
              </details>
              <details>
                <summary>Есть ли апгрейд “тише и дальше”? <span class="chev" aria-hidden="true">
                  <svg class="ico18" viewBox="0 0 24 24" fill="none"><path d="M6 9l6 6 6-6" stroke="rgba(255,255,255,.85)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </span></summary>
                <p>Да: компрессия + hop-up + подбор резинки/нуба + настройка. Для “тише” — шимминг и демпферы.</p>
              </details>
            </div>
          </div>
        </div>
    ...
    <div class="section-title">
      <div>
        ...
        <p>Готовые пакеты апгрейда под твой стиль игры — быстро, предсказуемо, без “зоопарка” деталей.</p>
      </div>
      <a class="btn small" href="#tabs">Смотреть характеристики</a>
    </div>

    <div class="kits" aria-label="Наборы тюнинга">
      <div class="kit">
        <div class="kit-top">
          <label class="radio" style="flex:1; min-width:260px;">
            <input type="radio" name="tuningKit" value="0" checked />
            <div>
              <div class="kit-name">Пакет “Стабильность”</div>
              <div class="muted2" style="font-size:13px;">Для ровной работы и стабильной траектории</div>
            </div>
          </label>
          <span class="kit-tag">лучший старт</span>
        </div>
        <ul class="kit-list">
          <li>Резинка hop-up (универсальная) + нуб</li>
          <li>Чистка/обслуживание + базовая настройка</li>
          <li>Проверка компрессии, устранение подсосов (если есть)</li>
        </ul>
        <div class="kit-foot">
          <div>
            <div class="kit-price" data-kit-price="1490">1 490 грн</div>
            <div class="kit-note">Не увеличивает лимиты по скорости — делает привод “ровным”.</div>
          </div>
          <button class="btn small primary" type="button" data-add-kit="0">Добавить пакет</button>
        </div>
      </div>
      ...
      <div class="kit">
        <div class="kit-top">
          <label class="radio" style="flex:1; min-width:260px;">
            <input type="radio" name="tuningKit" value="1" />
            <div>
              <div class="kit-name">Пакет “Реакция”</div>
              <div class="muted2" style="font-size:13px;">Быстрее отклик + комфортнее очередь</div>
            </div>
          </label>
          <span class="kit-tag">скоростной</span>
        </div>
        <ul class="kit-list">
          <li>Обслуживание + шимминг + смазка</li>
          <li>Усиленные контакты/проводка (по необходимости)</li>
          <li>Настройка hop-up под 0.25–0.28г</li>
        </ul>
        <div class="kit-foot">
          <div>
            <div class="kit-price" data-kit-price="2490">2 490 грн</div>
            <div class="kit-note">Опционально добавь LiPo/зарядку ниже — соберём комплект.</div>
          </div>
          <button class="btn small primary" type="button" data-add-kit="1">Добавить пакет</button>
        </div>
      </div>
      ...
      <div class="kit">
        <div class="kit-top">
          <label class="radio" style="flex:1; min-width:260px;">
            <input type="radio" name="tuningKit" value="2" />
            <div>
              <div class="kit-name">Пакет “Дальность”</div>
              <div class="muted2" style="font-size:13px;">Упор на дальность и кучность (в рамках лимитов)</div>
            </div>
          </label>
          <span class="kit-tag">дальнобой</span>
        </div>
        <ul class="kit-list">
          <li>Точная настройка hop-up + резинка/нуб под конкретные шары</li>
          <li>Проверка компрессии + исправление утечек</li>
          <li>Рекомендации по шарам и настройкам под площадку</li>
        </ul>
        <div class="kit-foot">
          <div>
            <div class="kit-price" data-kit-price="3290">3 290 грн</div>
            <div class="kit-note">Если на площадке строгие лимиты — подберём безопасный вариант.</div>
          </div>
          <button class="btn small primary" type="button" data-add-kit="2">Добавить пакет</button>
        </div>
      </div>
    </div>

    <!-- ======================
      С ЭТИМ АВТОМАТОМ ПОКУПАЮТ (с количеством магазинов)
    ====================== -->
    <div class="bundle" style="margin-top:16px;" aria-label="Рекомендованные товары">
      <div class="bundle-head">
        ...
        <button class="btn small" type="button" id="selectRecommended">Выбрать рекомендованное</button>
      </div>
      ...
      <div class="bundle-body">
        <div class="bundle-items">
          <div class="addon">
            <div class="addon-top">
              <div>
                <div class="addon-title">Аккумулятор LiPo 7.4V (под CQB)</div>
                <div class="addon-meta">Безопасный старт • стабильная работа</div>
              </div>

              <div class="addon-controls">
                <label class="addon-check" title="Добавить">
                  <input type="checkbox" class="addonBox" data-addon-id="bat_74" data-addon-price="790" />
                  <span class="addon-price">790 грн</span>
                </label>
              </div>
            </div>
            <div class="muted2" style="font-size:13px;">Подберёшь разъём (T-Dean/Tamiya) на этапе заказа.</div>
          </div>

          <div class="addon">
            <div class="addon-top">
              <div>
                <div class="addon-title">Зарядка Smart (LiPo/Li-Ion)</div>
                <div class="addon-meta">Балансировка • защита</div>
              </div>

              <div class="addon-controls">
                <label class="addon-check" title="Добавить">
                  <input type="checkbox" class="addonBox" data-addon-id="charger_smart" data-addon-price="1290" />
                  <span class="addon-price">1 290 грн</span>
                </label>
              </div>
            </div>
            <div class="muted2" style="font-size:13px;">То, на чём экономить не стоит.</div>
          </div>

          <!-- MAGAZINE WITH QTY -->
          <div class="addon" data-has-qty="1">
            <div class="addon-top">
              <div>
                <div class="addon-title">Магазин M4 Mid-cap</div>
                <div class="addon-meta">Тихий • без гремящих шаров</div>
              </div>

              <div class="addon-controls">
                <label class="addon-check" title="Добавить">
                  <input type="checkbox" class="addonBox" data-addon-id="mag_midcap" data-addon-price="390" />
                  <span class="addon-price">390 грн/шт</span>
                </label>

                <div class="mini-qty" aria-label="Количество магазинов" aria-disabled="true">
                  <button type="button" class="aqMinus" aria-label="Минус">−</button>
                  <input type="text" class="aqInput" value="1" inputmode="numeric" />
                  <button type="button" class="aqPlus" aria-label="Плюс">+</button>
                </div>
              </div>
            </div>
            <div class="muted2" style="font-size:13px;">Рекомендуем минимум 2 шт. Можно выбрать количество.</div>
          </div>

          <div class="addon">
            <div class="addon-top">
              <div>
                <div class="addon-title">Шары 0.25г (1 кг)</div>
                <div class="addon-meta">Оптимум для CQB</div>
              </div>

              <div class="addon-controls">
                <label class="addon-check" title="Добавить">
                  <input type="checkbox" class="addonBox" data-addon-id="bbs_025" data-addon-price="390" />
                  <span class="addon-price">390 грн</span>
                </label>
              </div>
            </div>
            <div class="muted2" style="font-size:13px;">Под 0.28г — если хочешь стабильнее, но медленнее.</div>
          </div>
        </div>

        <div class="bundle-total">
          <div>
            <div class="muted2" style="font-size:13px;">Итого по добавкам (к товару):</div>
            <div class="sum" id="addonSum">0 грн</div>
          </div>
          <div class="row" style="flex-wrap:wrap; justify-content:flex-end;">
            <button class="btn" type="button" id="clearAddons">Очистить</button>
            <button class="btn primary" type="button" id="addBundleToCart">Добавить выбранное</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="related" aria-label="Похожие товары">
      <article class="p">
      ...
      <div class="footer-grid">
        <div>
          ...
          <p style="margin:0; color:var(--muted); font-size:13px; max-width:60ch;">
            Карточка товара: галерея, цена, количество, табы, отзывы, FAQ, тюнинг-пакеты и “с этим покупают” (с количеством магазинов).
          </p>
        </div>
  ...
  <script>
    (function(){
      ...
      const clamp = (n, min=1, max=99) => Math.max(min, Math.min(max, n));
      const toInt = (v) => {
      ...
      // add main product (demo)
      const addMainToCart = document.getElementById('addMainToCart');
      addMainToCart && addMainToCart.addEventListener('click', () => {
        alert('Добавлен основной товар. Кол-во: ' + qty.value);
      });
      ...
      // --- Kits ---
      const kitPrices = [1490, 2490, 3290];
      const kitRadios = Array.from(document.querySelectorAll('input[name="tuningKit"]'));
      const kitBtns = Array.from(document.querySelectorAll('[data-add-kit]'));
      kitBtns.forEach(btn => {
        btn.addEventListener('click', () => {
          const idx = parseInt(btn.getAttribute('data-add-kit'), 10);
          kitRadios.forEach(r => r.checked = (parseInt(r.value,10) === idx));
          alert('Пакет тюнинга добавлен: #' + (idx+1) + ' (' + kitPrices[idx] + ' грн)');
        });
      });

      // --- Add-ons bundle (WITH QTY) ---
      const addonBoxes = Array.from(document.querySelectorAll('.addonBox'));
      const addonSumEl = document.getElementById('addonSum');
      const clearAddons = document.getElementById('clearAddons');
      const addBundleToCart = document.getElementById('addBundleToCart');
      const selectRecommended = document.getElementById('selectRecommended');

      function fmt(n){
        return n.toString().replace(/\B(?=(\d{3})+(?!\d))/g,' ') + ' грн';
      }
      function getAddonQty(box){
        // qty is only for blocks that have .mini-qty рядом
        const addon = box.closest('.addon');
        const input = addon ? addon.querySelector('.aqInput') : null;
        if (!input) return 1;
        const n = parseInt(String(input.value).replace(/[^\d]/g,''), 10);
        return Number.isFinite(n) ? Math.max(1, Math.min(99, n)) : 1;
      }

      function setMiniQtyEnabled(addonEl, enabled){
        const mq = addonEl.querySelector('.mini-qty');
        if (!mq) return;
        mq.setAttribute('aria-disabled', enabled ? 'false' : 'true');
      }

      function calcAddonSum(){
        let sum = 0;
        addonBoxes.forEach(b => {
          if (!b.checked) return;
          const price = parseInt(b.dataset.addonPrice,10) || 0;
          const q = getAddonQty(b);
          sum += price * q;
        });
        addonSumEl.textContent = fmt(sum);
        return sum;
      }
      ...
      addonBoxes.forEach(b => {
        b.addEventListener('change', () => {
          const addonEl = b.closest('.addon');
          if (addonEl && addonEl.querySelector('.mini-qty')) {
            setMiniQtyEnabled(addonEl, b.checked);
          }
          calcAddonSum();
        });
      });
      ...
      document.querySelectorAll('.addon').forEach(addonEl => {
        const box = addonEl.querySelector('.addonBox');
        const mq = addonEl.querySelector('.mini-qty');
        if (!mq || !box) return;

        const minusBtn = mq.querySelector('.aqMinus');
        const plusBtn = mq.querySelector('.aqPlus');
        const input = mq.querySelector('.aqInput');

        const clampMini = (v)=> Math.max(1, Math.min(99, v));
        const read = ()=> {
          const n = parseInt(String(input.value).replace(/[^\d]/g,''), 10);
          return Number.isFinite(n) ? clampMini(n) : 1;
        };
        const write = (v)=> { input.value = clampMini(v); };

        minusBtn.addEventListener('click', () => { write(read()-1); if (box.checked) calcAddonSum(); });
        plusBtn.addEventListener('click', () => { write(read()+1); if (box.checked) calcAddonSum(); });
        input.addEventListener('input', () => { write(read()); if (box.checked) calcAddonSum(); });

        // initial disabled until checked
        setMiniQtyEnabled(addonEl, box.checked);
      });

      // initial sum
      calcAddonSum();

      clearAddons && clearAddons.addEventListener('click', () => {
        addonBoxes.forEach(b => b.checked = false);
        // disable all mini qty
        document.querySelectorAll('.addon').forEach(a => setMiniQtyEnabled(a, false));
        calcAddonSum();
      });

      selectRecommended && selectRecommended.addEventListener('click', () => {
        addonBoxes.forEach(b => b.checked = false);

        // choose: battery + charger + bbs + magazines(2)
        addonBoxes.forEach(b => {
          const id = b.dataset.addonId;
          if (id === 'bat_74' || id === 'charger_smart' || id === 'bbs_025' || id === 'mag_midcap') b.checked = true;
          ...
          if (addonEl && addonEl.querySelector('.mini-qty')) {
            ...
            // set magazines qty = 2
            if (id === 'mag_midcap') {
              const input = addonEl.querySelector('.aqInput');
      ...
      addBundleToCart && addBundleToCart.addEventListener('click', () => {
        const selected = addonBoxes
          .filter(b => b.checked)
          .map(b => ({
            id: b.dataset.addonId,
            price: parseInt(b.dataset.addonPrice,10),
            qty: getAddonQty(b)
          }));
        const sum = calcAddonSum();
        if (!selected.length){
          alert('Выбери хотя бы один рекомендованный товар.');
          return;
        }
        alert('Добавлено позиций: ' + selected.length + '. Сумма добавок: ' + sum + ' грн\n' +
              selected.map(x => `${x.id} x${x.qty}`).join(', '));
      });
    })();
  </script>
</body>
