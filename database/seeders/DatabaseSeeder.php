...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products[] = Product::create([
            ...
            'tuning_kits' => [
                [
                    'name' => 'Пакет "Стабільність"',
                    'description' => 'Для рівної роботи та стабільної траєкторії',
                    'tag' => 'кращий старт',
                    'price' => 1490,
                    'items' => [
                        'Резинка hop-up (універсальна) + нуб',
                        'Чистка/обслуговування + базове налаштування',
                        'Перевірка компресії, усунення підсосів (якщо є)',
                    ],
                    'note' => 'Не збільшує ліміти по швидкості — робить привід "рівним".',
                ],
                [
                    'name' => 'Пакет "Реакція"',
                    'description' => 'Швидше відгук + комфортніша черга',
                    'tag' => 'швидкісний',
                    'price' => 2490,
                    'items' => [
                        'Обслуговування + shimming + змазка',
                        'Посилені контакти/проводка (за необхідності)',
                        'Налаштування hop-up під 0.25–0.28г',
                    ],
                    'note' => 'Опціонально додай LiPo/зарядку нижче — зберемо комплект.',
                ],
                [
                    'name' => 'Пакет "Дальність"',
                    'description' => 'Упор на дальність і купчість (в рамках лімітів)',
                    'tag' => 'далекобій',
                    'price' => 3290,
                    'items' => [
                        'Точне налаштування hop-up + резинка/нуб під конкретні кулі',
                        'Перевірка компресії + виправлення витоків',
                        'Рекомендації по кулям та налаштуванням під майданчик',
                    ],
                    'note' => 'Якщо на майданчику суворі ліміти — підберемо безпечний варіант.',
                ],
            ],
        ]);
